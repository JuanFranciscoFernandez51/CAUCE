...
export const CASOS_REALES: CasoReal[] = [
  {
    ...
    shotsAdmin: [
      { titulo: "Dashboard", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160593/cauce/sistema/casos/motos-fernandez/admin-full/ghi9ov8jkz4ugxihhmep.png" },
      { titulo: "Stock de motos", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160600/cauce/sistema/casos/motos-fernandez/admin-full/fpllvctrk8ocsgzjtiyd.png" },
      { titulo: "Mandatos de venta", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160605/cauce/sistema/casos/motos-fernandez/admin-full/ylfuvhs2pgubp8nzkftu.png" },
      { titulo: "Cargar mandato (documento descargable)", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160611/cauce/sistema/casos/motos-fernandez/admin-full/i1wtoifrddacmi2ongkc.png" },
      { titulo: "Órdenes de compra (boleto)", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160618/cauce/sistema/casos/motos-fernandez/admin-full/uwwuop8ycjhgfqztuv65.png" },
      { titulo: "Presupuestos", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160626/cauce/sistema/casos/motos-fernandez/admin-full/ax0pekd9yt1yhzv6rvg6.png" },
      { titulo: "Financiación propia", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160640/cauce/sistema/casos/motos-fernandez/admin-full/mq3wfpt97abgnnpk9icz.png" },
      { titulo: "Tesorería", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160645/cauce/sistema/casos/motos-fernandez/admin-full/xsmansai4pxxe0rqiktw.png" },
      { titulo: "Cuotas y vencimientos", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160650/cauce/sistema/casos/motos-fernandez/admin-full/v8pbt2hbz8kiekozinzp.png" },
      { titulo: "Taller — órdenes de trabajo", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160654/cauce/sistema/casos/motos-fernandez/admin-full/np8mfyo8ys7cs0evnivi.png" },
      { titulo: "Turnos del taller", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160659/cauce/sistema/casos/motos-fernandez/admin-full/e3nu98prgrdytsbcq4kg.png" },
      { titulo: "Calendario", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160664/cauce/sistema/casos/motos-fernandez/admin-full/je2siickhmtcnfken8fw.png" },
      { titulo: "Modelos 0KM", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160671/cauce/sistema/casos/motos-fernandez/admin-full/lbzzffx6ymyonar7rgje.png" },
      { titulo: "Productos de la tienda", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160679/cauce/sistema/casos/motos-fernandez/admin-full/uhovgasjrmdhnieph9ur.png" },
      { titulo: "Pedidos de la tienda", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160683/cauce/sistema/casos/motos-fernandez/admin-full/ayxmyheoyspeogowe9on.png" },
      { titulo: "Cupones de descuento", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160688/cauce/sistema/casos/motos-fernandez/admin-full/umd0thk9iwdcc4vx2tyz.png" },
      { titulo: "Promociones", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160692/cauce/sistema/casos/motos-fernandez/admin-full/citflo6glq4lhv36by6p.png" },
      { titulo: "CRM / Leads", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160699/cauce/sistema/casos/motos-fernandez/admin-full/lf11swomqeongfmdvatn.png" },
      { titulo: "Clientes", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160706/cauce/sistema/casos/motos-fernandez/admin-full/cb69siwb7euklvxzhkjd.png" },
      { titulo: "Outreach — avisos por WhatsApp", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160710/cauce/sistema/casos/motos-fernandez/admin-full/zr3dnmfwsvqxgpxub6ar.png" },
      { titulo: "Instagram — publicar con un botón", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160715/cauce/sistema/casos/motos-fernandez/admin-full/vtsu2saefw4rpfioadgt.png" },
      { titulo: "Calendario de publicaciones", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160720/cauce/sistema/casos/motos-fernandez/admin-full/ri18qtivzq5ij1qstrsi.png" },
      { titulo: "Meta Ads desde el panel", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160724/cauce/sistema/casos/motos-fernandez/admin-full/vn7e2hhhrmmu8ft3tpfx.png" },
      { titulo: "Mercado Libre — publicar con un botón", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160729/cauce/sistema/casos/motos-fernandez/admin-full/rue5rva37dahtuuwqikg.png" },
      { titulo: "Noticias / blog", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160734/cauce/sistema/casos/motos-fernandez/admin-full/mqsgtslld7butpnngeqw.png" },
      { titulo: "Newsletter", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160738/cauce/sistema/casos/motos-fernandez/admin-full/gxz6rhqvaksh2hachtvl.png" },
      { titulo: "Testimonios", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160743/cauce/sistema/casos/motos-fernandez/admin-full/r8ftexgeazoppbbqrsco.png" },
      { titulo: "Finanzas", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160748/cauce/sistema/casos/motos-fernandez/admin-full/g8rjs7rdbfje15vvn0wa.png" },
      { titulo: "Finanzas — libro de movimientos", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160754/cauce/sistema/casos/motos-fernandez/admin-full/dt5vyiymxzs05qwahayz.png" },
      { titulo: "Finanzas — matriz anual", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160758/cauce/sistema/casos/motos-fernandez/admin-full/chfpdp1bcsskopbro950.png" },
      { titulo: "Finanzas — cuentas y cheques", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160764/cauce/sistema/casos/motos-fernandez/admin-full/zkztd6wq9r1zgmachxli.png" },
      { titulo: "Finanzas — costos fijos", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160769/cauce/sistema/casos/motos-fernandez/admin-full/srvpsrvo9qo8jakfcbfl.png" },
      { titulo: "Para el contador", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160773/cauce/sistema/casos/motos-fernandez/admin-full/dvcozlhzxaxx9eecmyik.png" },
      { titulo: "Facturación (ARCA)", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160778/cauce/sistema/casos/motos-fernandez/admin-full/pmh270asdyfxwh5f88tg.png" },
      { titulo: "Proveedores", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160783/cauce/sistema/casos/motos-fernandez/admin-full/jqlgbj9d0vrjrwnxhx5u.png" },
      { titulo: "Sistema — procesos automáticos", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160788/cauce/sistema/casos/motos-fernandez/admin-full/b7p3lausrawv94ucohbb.png" },
      { titulo: "Asistente IA", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160792/cauce/sistema/casos/motos-fernandez/admin-full/ojsj7snqdjalmqsdcidn.png" },
    ],
    proceso: [
  ...
  },
  {
    ...
    shotsAdmin: [
      { titulo: "Dashboard", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160810/cauce/sistema/casos/vespa-bahia/admin-full/mttiuut0uvzgjodaqhxr.png" },
      { titulo: "Tareas pendientes", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160815/cauce/sistema/casos/vespa-bahia/admin-full/lggfd58t9io8nhxhmtma.png" },
      { titulo: "Stock por unidad física", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160822/cauce/sistema/casos/vespa-bahia/admin-full/eqpda4hjaubsig1rfw3a.png" },
      { titulo: "Vendidas", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160828/cauce/sistema/casos/vespa-bahia/admin-full/lypa8ysz90xreplx4rgn.png" },
      { titulo: "Cargar stock desde factura", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160833/cauce/sistema/casos/vespa-bahia/admin-full/selcrjhweacf2d3smmgl.png" },
      { titulo: "Mandatos de venta", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160838/cauce/sistema/casos/vespa-bahia/admin-full/fl4ghlmxsxnalpj3ppbi.png" },
      { titulo: "Órdenes de compra (boleto)", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160845/cauce/sistema/casos/vespa-bahia/admin-full/me4gofhgmth8b4sssx01.png" },
      { titulo: "Presupuestos", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160850/cauce/sistema/casos/vespa-bahia/admin-full/cwrlybzt3h7ztsvi5d1t.png" },
      { titulo: "Taller — órdenes de trabajo", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160855/cauce/sistema/casos/vespa-bahia/admin-full/lytkmviqjmtxvfecaw9l.png" },
      { titulo: "Turnos del taller", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160860/cauce/sistema/casos/vespa-bahia/admin-full/oyasjmwulxjstcal71lk.png" },
      { titulo: "Test rides agendados desde la web", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160865/cauce/sistema/casos/vespa-bahia/admin-full/eukvwytyolh3b0ijuj82.png" },
      { titulo: "Calendario", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160871/cauce/sistema/casos/vespa-bahia/admin-full/uvn5v5zzh9zjpxuof79o.png" },
      { titulo: "Modelos", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160879/cauce/sistema/casos/vespa-bahia/admin-full/tjmlosfgm8usbeihe5lc.png" },
      { titulo: "Productos de la tienda", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160890/cauce/sistema/casos/vespa-bahia/admin-full/oqzqfuvn15nfbisk9uav.png" },
      { titulo: "Pedidos de la tienda", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160899/cauce/sistema/casos/vespa-bahia/admin-full/soflvumlnehctclxjb6k.png" },
      { titulo: "Cupones", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160907/cauce/sistema/casos/vespa-bahia/admin-full/mxjydymgnpz52b7olsxo.png" },
      { titulo: "Promociones", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160912/cauce/sistema/casos/vespa-bahia/admin-full/usnbsusesxsvuxf94ink.png" },
      { titulo: "Hot Sale", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160918/cauce/sistema/casos/vespa-bahia/admin-full/zpi5ftqjas2jsuzrpgeo.png" },
      { titulo: "CRM / Leads", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160926/cauce/sistema/casos/vespa-bahia/admin-full/irjfdyclsfkms35aozui.png" },
      { titulo: "Clientes", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160932/cauce/sistema/casos/vespa-bahia/admin-full/vybe5tmbtj3fikgux8gb.png" },
      { titulo: "Finanzas — resumen general", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160937/cauce/sistema/casos/vespa-bahia/admin-full/xki6f29mjwdaebasoesb.png" },
      { titulo: "Finanzas — libro de movimientos", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160947/cauce/sistema/casos/vespa-bahia/admin-full/ragn5bm0iklygvyv2aza.png" },
      { titulo: "Finanzas — matriz anual", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160954/cauce/sistema/casos/vespa-bahia/admin-full/hrjbtf52sxim3zeybkil.png" },
      { titulo: "Finanzas — cartera", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160961/cauce/sistema/casos/vespa-bahia/admin-full/qmp7mmew8xx9wv34z5uv.png" },
      { titulo: "Finanzas — costos fijos", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160969/cauce/sistema/casos/vespa-bahia/admin-full/i3zifvkslvjhghyk0isf.png" },
      { titulo: "Facturación (ARCA)", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160978/cauce/sistema/casos/vespa-bahia/admin-full/wkfiulzmwdiml9d9nehv.png" },
      { titulo: "Tesorería", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160984/cauce/sistema/casos/vespa-bahia/admin-full/xpvzraniqpxzq09jqszl.png" },
      { titulo: "Códigos QR", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160990/cauce/sistema/casos/vespa-bahia/admin-full/ui7jtjagirqnju4eod5u.png" },
      { titulo: "Noticias", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785160998/cauce/sistema/casos/vespa-bahia/admin-full/gwjiatstj93ld21arnvf.png" },
      { titulo: "Proveedores", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161003/cauce/sistema/casos/vespa-bahia/admin-full/ffdn9aqttizlnbhoblys.png" },
    ],
    proceso: [
  ...
  },
  {
    ...
    shotsSlug: "zatiori",
    shotsAdmin: [
      { titulo: "Dashboard", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161018/cauce/sistema/casos/zatiori-espejos/admin-full/qbrgu3lteajkbk7xmrjh.png" },
      { titulo: "Pedidos — pipeline de 6 estados", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161023/cauce/sistema/casos/zatiori-espejos/admin-full/q8vbdqxq9f4w7ndvancs.png" },
      { titulo: "Cargar pedido a medida", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161029/cauce/sistema/casos/zatiori-espejos/admin-full/rgnun9uyqbydnw9y0w67.png" },
      { titulo: "Cola de fábrica", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161036/cauce/sistema/casos/zatiori-espejos/admin-full/fosln0jpbr7uku6nu96u.png" },
      { titulo: "Catálogo", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161042/cauce/sistema/casos/zatiori-espejos/admin-full/mppz1qoypgqiwbxuxeow.png" },
      { titulo: "Publicar espejo", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161048/cauce/sistema/casos/zatiori-espejos/admin-full/czlnokz6iyg08e4ewrcm.png" },
      { titulo: "Clientes", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161053/cauce/sistema/casos/zatiori-espejos/admin-full/lwzep9ix5yy0isz0axkl.png" },
      { titulo: "Proveedores", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161058/cauce/sistema/casos/zatiori-espejos/admin-full/jzjhcpils99kzammayko.png" },
      { titulo: "Instagram automático", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161065/cauce/sistema/casos/zatiori-espejos/admin-full/wa8c3fgt4qi8zuqiiehw.png" },
      { titulo: "Reseñas verificadas", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161070/cauce/sistema/casos/zatiori-espejos/admin-full/oxxvtckgi4ictla7kbta.png" },
      { titulo: "Configuración", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161075/cauce/sistema/casos/zatiori-espejos/admin-full/ilmk09wdqryajznqauro.png" },
    ],
    proceso: [
  ...
  },
  {
    ...
    shotsAdmin: [
      { titulo: "Dashboard", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161093/cauce/sistema/casos/la-base/admin-full/vvyddiabr2yytgprtwsy.png" },
      { titulo: "Hoy — el parte del día", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161102/cauce/sistema/casos/la-base/admin-full/yo3bnqtszu4lgbnuxukc.png" },
      { titulo: "Calendario del mes", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161111/cauce/sistema/casos/la-base/admin-full/ict4mdsie39dbs3ti5jb.png" },
      { titulo: "Reservas", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161128/cauce/sistema/casos/la-base/admin-full/nk2m1vxnhxi5xilcuhtx.png" },
      { titulo: "Cargar reserva", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161137/cauce/sistema/casos/la-base/admin-full/ebcyqjkmwbygewczypb2.png" },
      { titulo: "Check-in con QR", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161144/cauce/sistema/casos/la-base/admin-full/ur8dlfshk5ori3gxf58p.png" },
      { titulo: "Caja en 4 monedas", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161151/cauce/sistema/casos/la-base/admin-full/jfe3qusef5k2jr0hxdyz.png" },
      { titulo: "Lista de espera", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161159/cauce/sistema/casos/la-base/admin-full/xjmvkdej4gdafjv714uo.png" },
      { titulo: "Rental de equipos", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161168/cauce/sistema/casos/la-base/admin-full/yvmujmzcwjzixiclzfr5.png" },
      { titulo: "Instructores", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161176/cauce/sistema/casos/la-base/admin-full/vsegdvxouynpfertsm4r.png" },
      { titulo: "Mi agenda (vista del instructor)", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161183/cauce/sistema/casos/la-base/admin-full/ijfazb5zpb84paxejbji.png" },
      { titulo: "Liquidaciones de instructores", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161191/cauce/sistema/casos/la-base/admin-full/azdj8nmbedjd0rbd7nli.png" },
      { titulo: "Bolsa de trabajo", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161199/cauce/sistema/casos/la-base/admin-full/xtom7mqxzvcu3ezj2bvx.png" },
      { titulo: "Leads", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161208/cauce/sistema/casos/la-base/admin-full/tnwadij6reitgqhxjpbz.png" },
      { titulo: "Tarifas de temporada", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161216/cauce/sistema/casos/la-base/admin-full/zzxdr2f5cqelnknvaour.png" },
      { titulo: "Temporada", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161223/cauce/sistema/casos/la-base/admin-full/csjemaisgoczgcjdsboc.png" },
      { titulo: "Noticias", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161230/cauce/sistema/casos/la-base/admin-full/hrwcysx06sk3ha0aijl5.png" },
      { titulo: "Auditoría — quién hizo qué", url: "https://res.cloudinary.com/dgtlyzyra/image/upload/v1785161239/cauce/sistema/casos/la-base/admin-full/zxmbp81syh0bzd6gngiq.png" },
    ],
    shotsReales: [
