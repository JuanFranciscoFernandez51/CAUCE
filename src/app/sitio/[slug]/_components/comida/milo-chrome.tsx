...
function IconoWhatsApp({ wa }: { wa: string | null }) {
  if (!wa) return null;
  return (
    <a href={`https://wa.me/${wa}`} target="_blank" rel="noreferrer" aria-label="WhatsApp" title="Pedir por WhatsApp" className="p-2 transition-all duration-200 hover:-translate-y-0.5 hover:opacity-80 active:scale-[0.95] motion-reduce:transform-none">
