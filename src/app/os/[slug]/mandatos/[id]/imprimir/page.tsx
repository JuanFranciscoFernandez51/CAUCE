...
import { conceSettings, esConcesionaria } from "@/lib/conce-server";
import { fmtPrecioVehiculo, nombreVehiculo } from "@/lib/conce";
...
export default async function ImprimirOperacionPage({
  ...
  return (
    <Imprimible
      ...
      titulo={esMandato ? `Mandato de venta #${op.numero}` : `Boleto de compraventa #${op.numero}`}
