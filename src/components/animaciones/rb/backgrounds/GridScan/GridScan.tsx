// @ts-nocheck
"use client";
// face-api.js no está instalado en Cauce: se carga en runtime solo si enableWebcam=true
// (para usar la webcam hay que instalar el paquete). Así no rompe el build.
let faceapi: any = null;
async function cargarFaceApi() {
  if (faceapi) return faceapi;
  const mod = 'face-api.js';
  faceapi = await import(/* webpackIgnore: true */ /* turbopackIgnore: true */ mod);
  return faceapi;
}
